...
if __name__ == '__main__':	
	...
	parser.add_argument('-L', '--light', default=False, help='Uses only one library for the assembly process in order to speed the process. If the argument favourite is set, it will use it; otherwise it will select one with the same criteria as the one it uses for the variant calling protocol')
	...
	if not args.reference:
		call_SPAdes(prepared_libs, config_dict['SPAdes'][0], true_output, name, config_dict['SPAdes'][1], False, ram_limit, n_nodes, champion, args.light)
